...
document.querySelector('#button1').addEventListener('click', function(){
    ...
    var beta = variable2 + variable4 + variable5;
    var omega = variable2 + variable3 + variable5;
    var gamma = variable2 + variable3 + variable4;



    //conclude the equation
    if (var1 === "") {
        var missing1 = variable2 + variable3 + variable4 + variable5;
